...
dnf install -y gnome-shell-extension-dash-to-dock htop nmon inxi figlet btop nvtop google-noto-fonts-common google-noto-emoji-color-fonts google-noto-emoji-fonts
